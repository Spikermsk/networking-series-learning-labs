## Cisco DevNet Learning Labs: Networking Series

These self-paced interactive tutorials provide instructions for developers to  learn the basics of network devices, interfaces, software-defined networks (SDN), and REST APIs.
...
* Understand the networking basics and Software-Defined Networks.
* Understand network topologies and cables along with the OSI and TCP/IP Suite network models.
* How to work with IPv4 addresses, binary numbers, and subnetting.
...
These labs should help you understand networking concepts.
